...
archs = OrderedDict()
archs['alexnet'] = [256, 3, 224, 224]
archs['vgg11'] = [256, 3, 224, 224]
archs['googlenet'] = [256, 3, 224, 224]
archs['overfeat'] = [256, 3, 231, 231]
archs['inception_v3'] = [256, 3, 299, 299]
archs['inceptionv4'] = [256, 3, 299, 299]
archs['resnet50'] = [256, 3, 224, 224]
archs['resnet152'] = [256, 3, 224, 224]
