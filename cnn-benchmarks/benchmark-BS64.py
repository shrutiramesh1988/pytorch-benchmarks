...
archs = OrderedDict()
archs['alexnet'] = [64, 3, 224, 224]
archs['vgg11'] = [64, 3, 224, 224]
archs['googlenet'] = [64, 3, 224, 224]
archs['overfeat'] = [64, 3, 231, 231]
archs['inception_v3'] = [64, 3, 299, 299]
archs['inceptionv4'] = [64, 3, 299, 299]
archs['resnet50'] = [64, 3, 224, 224]
archs['resnet152'] = [64, 3, 224, 224]
